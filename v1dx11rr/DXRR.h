...
public:	
	...
	//ModeloRR* manzana;
	//ModeloRR* mochila;
	//ModeloRR* piramide; //Falta arreglar algunas caras :(
	//ModeloRR* sarcofago;
	//ModeloRR* tesoro;
    ...
    DXRR(HWND hWnd, int Ancho, int Alto)
	{
		...
		//esfinje = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Esfinge/esfinge_1.obj", L"Assets/Modelos/Esfinge/arena_textura.jpg", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//camello = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Camello/camello_solo.obj", L"Assets/Modelos/Camello/camello_textura_UNO.jpg", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//cactus = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Cactaceas/cactus_solo.obj", L"Assets/Modelos/Cactaceas/cactus_textura.jpg", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//casa = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Casa/casa_sola.obj", L"Assets/Modelos/Casa/casa_textura.jpg", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//cubeta = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Cubeta/cubeta_sola.obj", L"Assets/Modelos/Cubeta/cubeta_textura.png", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//manzana = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Manzana/manzana_sola.obj", L"Assets/Modelos/Manzana/manzana_textura.png", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//mochila = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Mochila/mochila_sola.obj", L"Assets/Modelos/Mochila/mochila_textura.png", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//piramide = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Piramide/piramide_sola.obj", L"Assets/Modelos/Esfinge/arena_textura.jpg", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//sarcofago = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Sarcofago/sarcofago_solo.obj", L"Assets/Modelos/Sarcofago/sarcofago_textura.jpg", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
		//tesoro = new ModeloRR(d3dDevice, d3dContext, "Assets/Modelos/Tesoro/tesoro_solo.obj", L"Assets/Modelos/Tesoro/tesoro_textura.png", L"Assets/Modelos/Esfinge/arena_espec.jpg", 0, 0);
	...
	void Render(void)
	{
		...
		//esfinje->Draw(camara->vista, camara->proyeccion, terreno->Superficie(10, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//camello->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//cactus->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//casa->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//cubeta->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//manzana->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//mochila->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//piramide->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//sarcofago->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
		//tesoro->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1);
